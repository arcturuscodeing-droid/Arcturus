...
const ArcturusEngine = (() => {
    ...
    function selectCastingCandidates(ranked) {
        return ranked.filter(r => r.castCapable);
    }
    ...
    function createStandby() {
        ...
        // Track which ranked source this standby belongs to for instant failover matching.
        f.setAttribute('data-arcturus-source-id', next.source.id);
